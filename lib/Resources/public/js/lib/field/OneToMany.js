...
(function(){
    ...
    {
        this.extend(this, ag.u.tpl("agitadmin-forms", ".onetomany"));
    };
    ...
    oneToManyField.prototype.sortRows = function()
    {
        // implementations can use this to re-arrange the existing rows after an element is added or removed.
    };
