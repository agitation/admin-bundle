...
(function(){
    var
        oneToManyEntityFooter = function(entityName, childEntityName, childEntityPropertyName)
        {
            ag.admin.field.OneToManyFooter.call(this, entityName);

            this.selectField = new ag.admin.field.LoadableEntitySelect(this.find("select"), childEntityName);
